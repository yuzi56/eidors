...
SALT='z$Id: mk_geophysics_model.m 6521 2022-12-30 21:33:17Z bgrychtol $'; % stick a key in the model 'save' file, so we can expire them when the model definitions age
