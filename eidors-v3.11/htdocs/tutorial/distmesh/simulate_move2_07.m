...
% create model $Id: simulate_move2_07.m 6459 2022-12-08 14:09:24Z aadler $
%% 1
% Model parameters
n_elec= 16;
n_nodes= 500;
...
% Create electrodes
refine_level=2; %electrode refinement level
elec_width= .1;
z_contact = 0.01;
% elect positions
...
%% 3 simulate homogeneous $Id: simulate_move2_07.m 6459 2022-12-08 14:09:24Z aadler $
...
%% 4 moving target $Id: simulate_move2_07.m 6459 2022-12-08 14:09:24Z aadler $
...
for i= 1:n_sims;
   ...
   print_convert(sprintf('simulate_move2_04b%02d.png',i),'-density 50');
   vi(i)= fwd_solve(timg);
end

%% 5 Create animated graphics $Id: simulate_move2_07.m 6459 2022-12-08 14:09:24Z aadler $

% Trim images
system('find -name ''simulate_move2_04b*.png'' -exec convert  -trim "{}" PNG8:"{}" ";"')

% Convert to animated Gif
system('convert -delay 50 simulate_move2_04b*.png -loop 0 simulate_move2_05b.gif')

%% 6 Reconstruct images $Id: simulate_move2_07.m 6459 2022-12-08 14:09:24Z aadler $
...
print_convert simulate_move2_06b.png '-density 125'
